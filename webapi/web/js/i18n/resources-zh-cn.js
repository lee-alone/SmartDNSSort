...
const resourcesZhCn = {
    ...
    "dashboard": {
        ...
        "skippedPings": "已跳过",
        "efficiencyRate": "节约率",
        "pingRatio": "探测比例 (实际/计划)",
        "poolDynamics": "池动态分析",
        "downgradedIPs": "降级 IP 数",
        "downgradedIPsDesc": "处于静默监测状态的 IP",
        "t0PoolNote": "核心池，包含 {{size}} 个活跃 IP",
        "quotaMonitoring": "配额监控",
        "hourlyQuota": "小时配额",
        "statusHealthy": "状态：运行健康",
        "statusWarning": "状态：触发限流",
        "statusLimitReached": "状态：配额已满",
        "ip": "IP 地址",
        "repDomain": "代表域名",
        "refCount": "引用计数",
        "accessHeat": "访问热度",
